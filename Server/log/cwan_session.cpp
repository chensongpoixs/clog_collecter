...
purpose:	ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ýµï¿½ï¿½Õ·ï¿½
...
//#include "cclient_collection_mgr.h"
#include "clog.h"
...
namespace chen {
	...
	void cwan_session::update(uint32 uDeltaTime)
	{
		...
		if ( (::time(NULL) - m_heart_beart) > g_cfg.get_uint32(ECI_HeartBeat))
		{
			WARNING_EX_LOG(" Beart_Heart [cur_time = %u][m_heart_beart  %u]", ::time(NULL), m_heart_beart);
